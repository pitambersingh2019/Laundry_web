...
const handleApproveToggle = async (driver) => {
    ...
    try {
        ...
        alert("Failed to update driver approval. Please try again.");
    } finally {
    ...
    return (
        <div className="ml-24 p-6 bg-gray-50 min-h-screen">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div>
                    <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm mr-4" onClick={() => setShowAddModal(true)}>
                        Add Driver
                    </button>
